...
class UserActions:
    ...
    def homerow_right_pick(label: str, again: bool):
        global search_again
...
class Actions:
    ...
    def homerow_right_pick(label: str, again: bool):
        """Right-click a label in Homerow, optionally continuing to search"""

    def homerow_hover(label: str):
        """Hover over a label in Homerow"""
